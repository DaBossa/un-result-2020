                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <p class="reveal r-bottom">Promote people's well-being and support equitable representation of countries in global decision-making fora.</p>
                                        <p class="reveal r-bottom">Promote people's well-being, including the protection and empowerment of groups that are vulnerable and marginalized.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-start">
                    <div class="col-12 col-md-6 col-lg-4 col-dados reveal">
                        ...
                        <ul class="items-numbers">
                            <li class="data-events reveal r-right" data-info="238">
                                <h4>238</h4>
                                <h5 class="reveal">Events</h5>
                            </li>
                            <li class="data-beneficiaries reveal r-right" data-info="111831">
                                <h4>111,831</h4>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-dados reveal">
                        ...
                        <ul class="items-numbers">
                            <li class="data-learning-events reveal r-right reveal r-right" data-info="98">
                                <h4>98</h4>
                                <h5 class="reveal">Learning events</h5>
                            </li>
                            <li class="data-learners reveal r-right" data-info="20653">
                                <h4>20,653</h4>
                                <h5 class="reveal">Learners</h5>
                            </li>
                            <li class="data-certificates reveal r-right" data-info="3529">
                                <h4>3,529</h4>
                    ...
                    <div class="col-lg-4">
                        <div class="selos reveal selos-col-5">
