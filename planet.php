                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <p>Support the conservation, restoration and safeguarding of our planet for present and future generations.</p>
                                        <p>Strengthen capacities to foster a green, low-carbon and climate resilient transition.</p>
                                    </div>
                                    <div class="col-xl-6">
                                        <p>Strengthen capacities to manage dangerous chemicals and wastes in a sound and sustainable manner.</p>
                                        <p>Improve the conservation and sustainable use of natural resources.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-start">
                    <div class="col-12 col-md-6 col-lg-4 col-dados">
                        ...
                        <ul class="items-numbers">
                            <li class="data-events" data-info="127">
                                <h4>127</h4>
                                <h5>Events</h5>
                            </li>
                            <li class="data-beneficiaries" data-info="167946">
                                <h4>167,946</h4>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-dados">
                        ...
                        <ul class="items-numbers">
                            <li class="data-learning-events" data-info="52">
                                <h4>52</h4>
                                <h5>Learning events</h5>
                            </li>
                            <li class="data-learners" data-info="153065">
                                <h4>153,065</h4>
                                <h5>Learners</h5>
                            </li>
                            <li class="data-certificates" data-info="32263">
                                <h4>32,263</h4>
                                <h5>Certificates</h5>
                            </li>
                        </ul>
                ...
                <div class="row align-items-center">
                    <div class="col-8 col-md-5 col-img">
                        <div class="image image-1">
                            ...
                            <img src="assets/images/pilar-<?php echo $page_class ?>-depoimento-01.jpg" alt="Maurici Tadeu Ferreira Santos - Brazil">
                        </div>
                    </div>
                ...
                <div class="row flex-md-row-reverse align-items-center">
                    <div class="col-8 col-md-5 col-img">
                        <div class="image image-2 stroke-<?php echo $page_class ?>">
                            <i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 671.31 751.31"><path d="M514,750,82,688,1,289,228,126H587l-1,396Z" style="fill:none;stroke:#fff;"/><path d="M161,1,590.65,61.65,670,461,442,626H86V228Z" style="fill:none;stroke:#fff;"/></svg></i>
                            <img src="assets/images/pilar-<?php echo $page_class ?>-depoimento-02.jpg" alt="Kafui Korshiwor Boni - Ghana">
                        </div>
                    </div>
                    <div class="col-md-7 content">
