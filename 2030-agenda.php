                    ...
                    <div class="col-lg-5 offset-lg-7 infos">
                        <div class="row">
                            <div class="col-12 col-md-4 col-lg-12">
                                <i><img src="assets/images/pillar-hero-icon-<?php echo $page_class ?>.png" alt="<?php echo $titulo ?>"></i>
                            </div>
                            <div class="col-md-8 col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <p>Optimizing the use of technology and supporting coherence for the 2030 agenda.</p>
                                        <p>Support coherence and evidenced-based policies of the 2030 Agenda.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-start">
                    <div class="col-12 col-md-6 col-lg-4 col-dados">
                        ...
                        <ul class="items-numbers">
                            <li class="data-events" data-info="38">
                                <h4>38</h4>
                                <h5>Events</h5>
                            </li>
                            <li class="data-beneficiaries" data-info="6925">
                                <h4>6,925</h4>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-dados">
                        ...
                        <ul class="items-numbers">
                            <li class="data-learning-events" data-info="21">
                                <h4>21</h4>
                                <h5>Learning events</h5>
                            </li>
                            <li class="data-learners" data-info="2362">
                                <h4>2,362</h4>
                                <h5>Learners</h5>
                            </li>
                            <li class="data-certificates" data-info="664">
                                <h4>664</h4>
                                <h5>Certificates</h5>
                            </li>
                        </ul>
                    ...
                    <div class="col-lg-4">
                        <div class="selos flex-row">
                            <img src="assets/images/pilar-icon-04.png" alt="">
                            <img src="assets/images/pilar-icon-17.png" alt="">
                        </div>
