                ...
                <div class="row align-items-start">
                    <div class="col-12 col-md-6 col-lg-4 col-dados reveal">
                        ...
                        <ul class="items-numbers">
                            <li class="data-events reveal r-right" data-info="45">
                                <h4>45</h4>
                                <h5 class="reveal">Events</h5>
                            </li>
                            <li class="data-beneficiaries reveal r-right" data-info="2828">
                                <h4>2,828</h4>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-dados reveal">
                        ...
                        <ul class="items-numbers">
                            <li class="data-learning-events reveal r-right reveal r-right" data-info="32">
                                <h4>32</h4>
                                <h5 class="reveal">Learning events</h5>
                            </li>
                            <li class="data-learners reveal r-right" data-info="2024">
                                <h4>2,024</h4>
                                <h5 class="reveal">Learners</h5>
                            </li>
                            <li class="data-certificates reveal r-right" data-info="1636">
                                <h4>1,636</h4>
