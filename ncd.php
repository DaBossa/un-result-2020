<?php
$color = "#1F7129";
$titulo = "The Defeat-NCD Partnership";
                ...
                <div class="row">
                    <div class="col-lg-9 col-xl-7 mx-auto">
                        ...
                        <div class="hl-item">
                            ...
                            <div class="content reveal">
                                <p>We organized multiple training workshops, webinars, panel discussions and events during 2020, to support capacity building, advocacy, and policy makers’ engagement.</p>
                            </div>
                        </div>
                        <div class="hl-item">
                            <img class="reveal r-bottom" src="assets/images/pilar-<?php echo $page_class ?>-icon-hl-08.svg" alt="">
                            <div class="content reveal">
                        ...
                        <div class="hl-item">
                            <img class="reveal r-bottom" src="assets/images/pilar-<?php echo $page_class ?>-icon-hl-09.svg" alt="">
                            <div class="content reveal">
                ...
                <div class="row align-items-center">
                    <div class="col-8 col-md-5 col-img">
                        <div class="image image-1">
                            ...
                            <img class="reveal r-scale-out" src="assets/images/pilar-<?php echo $page_class ?>-depoimento-01.jpg" alt="Dr Kyaw Kan Kaung - Myanmar">
                        </div>
                    </div>
                    <div class="col-md-7 content">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-3 d-flex justify-content-end">
                                <a href="https://www.unitar.org/sites/default/files/media/publication/doc/unitar_results_report_2020_web.pdf#page=58" class="btn icon i-seta i-seta-direita color-<?php echo $page_class ?>" target="_blank"><span>Read more</span></a>
                            </div>
                        </div>
                    </div>
                </div>
