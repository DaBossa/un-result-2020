                            ...
                            <div class="col-md-8 col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <p class="reveal r-bottom">Strengthen representation of countries in special situations in institutions of global governance.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-start">
                    <div class="col-12 col-md-6 col-lg-4 col-dados reveal">
                        ...
                        <ul class="items-numbers">
                            <li class="data-events reveal r-right" data-info="97">
                                <h4>97</h4>
                                <h5 class="reveal">Events</h5>
                            </li>
                            <li class="data-beneficiaries reveal r-right" data-info="4430">
                                <h4>4,430</h4>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-dados reveal">
                        ...
                        <ul class="items-numbers">
                            <li class="data-learning-events reveal r-right reveal r-right" data-info="81">
                                <h4>81</h4>
                                <h5 class="reveal">Learning events</h5>
                            </li>
                            <li class="data-learners reveal r-right" data-info="3816">
                                <h4>3,816</h4>
                                <h5 class="reveal">Learners</h5>
                            </li>
                            <li class="data-certificates reveal r-right" data-info="1989">
                                <h4>1,989</h4>
