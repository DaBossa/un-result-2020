                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <p>Optimizing the use of technology new technology, including geospatial technologies for evidence-based decision-making.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-start">
                    <div class="col-12 col-md-6 col-lg-4 col-dados">
                        ...
                        <ul class="items-numbers">
                            <li class="data-events" data-info="16">
                                <h4>16</h4>
                                <h5>Events</h5>
                            </li>
                            <li class="data-beneficiaries" data-info="470">
                                <h4>470</h4>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-dados">
                        ...
                        <ul class="items-numbers">
                            <li class="data-learning-events" data-info="16">
                                <h4>16</h4>
                                <h5>Learning events</h5>
                            </li>
                            <li class="data-learners" data-info="470">
                                <h4>470</h4>
                                <h5>Learners</h5>
                            </li>
                            <li class="data-certificates" data-info="269">
                                <h4>269</h4>
                                <h5>Certificates</h5>
                            </li>
                            <li class="data-products" data-info="1136">
                                <h4>1,136</h4>
                                <h5>Mapping products</h5>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-4">
                        <div class="selos">
                            <img src="assets/images/pilar-icon-09.png" class="order-xl-1" alt="">
                            <img src="assets/images/pilar-icon-11.png" class="order-xl-3" alt="">
                            <img src="assets/images/pilar-icon-13.png" class="order-xl-5" alt="">
                            <img src="assets/images/pilar-icon-16.png" class="order-xl-2" alt="">
                            <img src="assets/images/pilar-icon-17.png" class="order-xl-4" alt="">
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-8 col-md-5 col-img">
                        <div class="image image-1">
                            ...
                            <img src="assets/images/pilar-<?php echo $page_class ?>-depoimento-01.jpg" alt="Vibeke Oestreich Nielsen - USA">
                        </div>
                    </div>
