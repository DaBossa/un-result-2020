                    ...
                    <div class="col-lg-5 offset-lg-7 infos">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12">
                                <div class="row">
                                    <div class="col-11 reveal">
                                        <h1><?php echo $titulo ?></h1>
                                    </div>
                                    <div class="col-xl-12">
                                        <p class="reveal r-bottom">Optimizing the use of technology new technology, including geospatial technologies for evidence-based decision-making.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-start">
                    <div class="col-12 col-md-6 col-lg-4 col-dados reveal">
                        ...
                        <ul class="items-numbers">
                            <li class="data-events reveal r-right" data-info="16">
                                <h4>16</h4>
                                <h5 class="reveal">Events</h5>
                            </li>
                            <li class="data-beneficiaries reveal r-right" data-info="470">
                                <h4>470</h4>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-dados reveal">
                        ...
                        <ul class="items-numbers">
                            <li class="data-learning-events reveal r-right reveal r-right" data-info="16">
                                <h4>16</h4>
                                <h5 class="reveal">Learning events</h5>
                            </li>
                            <li class="data-learners reveal r-right" data-info="470">
                                <h4>470</h4>
                                <h5 class="reveal">Learners</h5>
                            </li>
                            <li class="data-certificates reveal r-right" data-info="269">
                                <h4>269</h4>
                                <h5 class="reveal">Certificates</h5>
                            </li>
                            <li class="data-products reveal r-right" data-info="1136">
                                <h4>1,136</h4>
                                <h5 class="reveal">Mapping products</h5>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-4">
